...
void main() {
  ...
  group('Alunos Routes - GET /', () {
    ...
    test('GET /alunos - deve incluir disciplinas matriculadas', () async {
      ...
      final alunoMatriculado = alunos.firstWhere(
        (a) => a['id'] == alunoIds[0],
      );

      expect(alunoMatriculado['disciplinas'], isA<List>());
      final disciplinas = alunoMatriculado['disciplinas'] as List;
      expect(disciplinas.any((d) => d['disciplina_id'] == disciplinaId), isTrue);
    });
  ...
  group('Alunos Routes - GET /:id/disciplinas', () {
    test('GET /alunos/:id/disciplinas - deve listar disciplinas do aluno', () async {
    ...
    test('GET /alunos/:id/disciplinas - deve retornar lista vazia para aluno sem disciplinas', () async {
      final response = await http.get(
  ...
  group('Alunos Routes - GET /disciplina/:id', () {
    test('GET /alunos/disciplina/:id - deve listar alunos da disciplina', () async {
      // Matricular aluno
      await http.post(
        Uri.parse('$baseUrl/alunos/matricular'),
        headers: {'Content-Type': 'application/json'},
    ...
    test('GET /alunos/disciplina/:id - deve retornar lista vazia para disciplina sem alunos', () async {
  ...
  group('Alunos Routes - GET /disponiveis/:disciplina_id', () {
    test('GET /alunos/disponiveis/:id - deve listar alunos não matriculados', () async {
    ...
    test('GET /alunos/disponiveis/:id - não deve incluir alunos já matriculados', () async {
      // Criar disciplina
      final discResponse = await http.post(
        Uri.parse('$baseUrl/disciplinas'),
        headers: {'Content-Type': 'application/json'},
    ...
    test('GET /alunos/disponiveis/:id - deve retornar todos se ninguém matriculado', () async {
  ...
  group('Alunos Routes - POST /matricular', () {
    test('POST /alunos/matricular - deve matricular aluno com sucesso', () async {
    ...
    test('POST /alunos/matricular - deve aparecer nas listas após matrícula', () async {
      // Criar disciplina
      final discResponse = await http.post(
        Uri.parse('$baseUrl/disciplinas'),
        headers: {'Content-Type': 'application/json'},
      ...
      expect(disciplinas.any((d) => d['disciplina_id'] == testDiscId), isTrue);
    });

    test('POST /alunos/matricular - deve rejeitar matrícula duplicada', () async {
      // Criar disciplina
      final discResponse = await http.post(
        Uri.parse('$baseUrl/disciplinas'),
        headers: {'Content-Type': 'application/json'},
    ...
    test('POST /alunos/matricular - deve rejeitar aluno_id inexistente', () async {
      final response = await http.post(
        Uri.parse('$baseUrl/alunos/matricular'),
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode({
    ...
    test('POST /alunos/matricular - deve rejeitar disciplina_id inexistente', () async {
      final response = await http.post(
        Uri.parse('$baseUrl/alunos/matricular'),
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode({
  ...
  group('Alunos Routes - DELETE /desmatricular', () {
    test('DELETE /alunos/desmatricular - deve remover matrícula com sucesso', () async {
    ...
    test('DELETE /alunos/desmatricular - não deve aparecer nas listas após', () async {
      // Criar disciplina e matricular
      final discResponse = await http.post(
        Uri.parse('$baseUrl/disciplinas'),
        headers: {'Content-Type': 'application/json'},
    ...
    test('DELETE /alunos/desmatricular - deve retornar 404 para matrícula inexistente', () async {
      final response = await http.delete(
        Uri.parse('$baseUrl/alunos/desmatricular'),
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode({
    ...
    test('DELETE /alunos/desmatricular - deve rejeitar sem disciplina_id', () async {
      final response = await http.delete(
        Uri.parse('$baseUrl/alunos/desmatricular'),
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode({
